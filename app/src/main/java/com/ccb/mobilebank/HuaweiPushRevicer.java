    ...
    public class HuaweiPushRevicer extends PushReceiver {
        ...
        public boolean onPushMsg(Context context, byte[] msg, Bundle bundle) {
            try {
                ...
                callBack(intent);
                Log.e("========","onPushMsg=="+"Receive a push pass message with the message:" + content);
            } catch (Exception e) {
                Intent intent = new Intent();
                intent.setAction(ACTION_UPDATEUI);
                intent.putExtra("log", "Receive push pass message, exception:" + e.getMessage());
                Log.e("========","onPushMsg=="+"Receive push pass message, exception:" +  e.getMessage());
                callBack(intent);
            }
            return false;
        }
        ...
        public void onEvent(Context context, Event event, Bundle extras) {
            ...
            callBack(intent);
            Log.e("========","onEvent=="+"Received event,notifyId::" + notifyId + " msg:" + message);
